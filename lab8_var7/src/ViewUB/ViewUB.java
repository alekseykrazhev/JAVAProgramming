...
public class ViewUB extends JFrame {
    ...
    public ViewUB() throws HeadlessException {
        ...
        JMenuItem look = new JMenuItem("Look and Feel");
        ...
        ascendingOrder.addActionListener(new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Collections.sort(data, ((one, two) -> {
                    return one.getHomeNumber() - two.getHomeNumber();
                }));
                listModel.clear();
        ...
        descendingOrder.addActionListener(new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                for (int i = 0; i < listModel.size(); ++i)
                    data.add(listModel.get(i));
                Collections.sort(data, ((one, two) -> {
                    return two.getHomeNumber() - one.getHomeNumber();
                }));
                listModel.clear();
                for (UtilityBill bill : data)
                    listModel.addElement(bill);
        ...
        submit.addActionListener(new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    listModel.addElement(new UtilityBill(homeNumber, flatNumber, address, name, paymentDate,
                            paymentAmount, finePercent, expirationDays));
